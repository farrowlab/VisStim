function [ gammaTable1, gammaTable2, displayBaseline, displayRange, displayGamma, maxLevel ] = CalibrateMonitorK(numMeasures, screenid)
...
load MyGammaTable
Screen('LoadNormalizedGammaTable', screenid, gammaTable*[1 1 1]);
%
%
% History:

...
%      CounterMovingBar = CounterMovingBar+1;
    ...
    case 'Translating Circle'
      
      StimLog = ShowTranslatingCircle(window,vparams,sparams);
      file_date = ['/home/farrowlab/StimLog/StimLog',datestr(now,['yyyy','mm','dd'])];
      mkdir(file_date);
      file_Stim = [file_date,'/TranslatingCircle']
      mkdir(file_Stim);
    ...
    case 'Translating Bar'
      
      StimLog = ShowTranslatingBar(window,vparams,sparams);
      file_date = ['/home/farrowlab/StimLog/StimLog',datestr(now,['yyyy','mm','dd'])];
      mkdir(file_date);
      file_Stim = [file_date,'/TranslatingBar']
      mkdir(file_Stim);

...
Screen('DrawDots',window,[imageX+Pos; imageY],22,[0 0 0],[0 0],2)
% %Flip to screen
...
Pos=amplitude*sin(angFreq*time+startPhase); 
  %Color screen grey with black dot
Screen('FillRect',window,[0.5 0.5 0.5]);
Screen('DrawDots',window,[imageX-Pos; imageY+Pos],22,[0 0 0],[0 0],2)
% %Flip to screen
 vbl=Screen('Flip',window,vbl+(waitframes-0.5)*ifi);
 % Time increment
 time=time+ifi;
...
Pos=amplitude*sin(angFreq*time+startPhase); 
  %Color screen grey with black dot
Screen('FillRect',window,[0.5 0.5 0.5]);
Screen('DrawDots',window,[imageX; imageY+Pos],22,[0 0 0],[0 0],2)
% %Flip to screen
 vbl=Screen('Flip',window,vbl+(waitframes-0.5)*ifi);
 % Time increment
 time=time+ifi;

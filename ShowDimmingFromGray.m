function StimLog = ShowDimmingFromGray(window, vparams, sparams)
...
% ---------------------- %
% --- Log parameters --- %
StimLog.StimulusClass = 'Dimming From Gray';   
...
for j = 1:trial
    ...
    % Linear dimming from gray starting at 0s  
    for i = 1:(nframes)     
      % Draw the rect to the screen
      dstRect = [0 0 xsize ysize];
      dstRect = CenterRectOnPointd(dstRect, xCenter, yCenter);
      Screen('FillOval', window, [lum_graydim_lin(i) lum_graydim_lin(i) lum_graydim_lin(i)], dstRect);
    ...
    % Linear dimming from gray starting at 2.4s  
    for i = 1:(nframes)     
      % Draw the rect to the screen
      dstRect = [0 0 xsize ysize];
      dstRect = CenterRectOnPointd(dstRect, xCenter, yCenter);
      Screen('FillOval', window, [lum_graydim_lin_24end(i) lum_graydim_lin_24end(i) lum_graydim_lin_24end(i)], dstRect);
    ...
    % Linear dimming from gray starting at 2.5s  
    for i = 1:(nframes)     
      % Draw the rect to the screen
      dstRect = [0 0 xsize ysize];
      dstRect = CenterRectOnPointd(dstRect, xCenter, yCenter);
      Screen('FillOval', window, [lum_graydim_lin_25end(i) lum_graydim_lin_25end(i) lum_graydim_lin_25end(i)], dstRect);
    ...
    % Linear dimming from gray starting at 2.6s  
    for i = 1:(nframes)     
      % Draw the rect to the screen
      dstRect = [0 0 xsize ysize];
      dstRect = CenterRectOnPointd(dstRect, xCenter, yCenter);
      Screen('FillOval', window, [lum_graydim_lin_26end(i) lum_graydim_lin_26end(i) lum_graydim_lin_26end(i)], dstRect);
    ...
    % Linear dimming from gray starting at 2.7s  
    for i = 1:(nframes)     
      % Draw the rect to the screen
      dstRect = [0 0 xsize ysize];
      dstRect = CenterRectOnPointd(dstRect, xCenter, yCenter);
      Screen('FillOval', window, [lum_graydim_lin_27end(i) lum_graydim_lin_27end(i) lum_graydim_lin_27end(i)], dstRect);
    ...
    % Linear dimming from gray starting at 2.8s  
    for i = 1:(nframes)     
      % Draw the rect to the screen
      dstRect = [0 0 xsize ysize];
      dstRect = CenterRectOnPointd(dstRect, xCenter, yCenter);
      Screen('FillOval', window, [lum_graydim_lin_28end(i) lum_graydim_lin_28end(i) lum_graydim_lin_28end(i)], dstRect);
    ...
    % Linear dimming from gray starting at 2.9s  
    for i = 1:(nframes)     
      % Draw the rect to the screen
      dstRect = [0 0 xsize ysize];
      dstRect = CenterRectOnPointd(dstRect, xCenter, yCenter);
      Screen('FillOval', window, [lum_graydim_lin_29end(i) lum_graydim_lin_29end(i) lum_graydim_lin_29end(i)], dstRect);

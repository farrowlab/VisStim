...
def main():
    # default inputs
    pars = [['Class','Translating Bar',''],
            ['Type','Single',''],
            ['Size',[60],'Width of bar'],
            ['Speed',[40],'Expanding speed'],
            ['Trial',1,'Number of trail'],
            ['Angle',[0,180,90,270,45,225,135,315],'Translating angle'],
    ...
    stimMessage = "Class:TranslatingBar;Type:Single;Size:_60;Speed:_40;Trial:1;Angle:_0_180_90_270_45_225_135_315_-1;ISI:5;StimLum:0;Xpos:640;Ypos:512;BgColour:125 125 125"

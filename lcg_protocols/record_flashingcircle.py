...
def main():
    # default inputs
    pars = [['Class','Flashing Circle',''],
            ['Type','Single',''],
            ['Size',[60],'Size of square'],
    ...
    stimMessage = "Class:FlashingCircle;Type:Single;Size:_5;Trial:1;Duration:_0.5;ISI:1;StimLum:1;Xpos:640;Ypos:512;BgColour:125 125 125"
